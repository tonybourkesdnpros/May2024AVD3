...
| --------- | --------------- | ------------ | --------- |
| mlag34 | Vlan4094 | 10.255.255.0 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet6 | routed | - | 192.168.3.5/31 | default | 1550 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet6 | routed | - | 192.168.3.7/31 | default | 1550 | False | - | - |
| Ethernet9 | - | routed | - | 10.1.5.2/31 | John | - | False | - | - |
...
| Port-Channel7 | host3_Connection to host3 | switched | access | 20 | - | - | - | - | 7 | - |
...
interface Port-Channel7
   description host3_Connection to host3
   no shutdown
   switchport
...
| Vlan3009 |  VRF_A  |  10.255.254.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  John  |  10.255.254.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.255.254.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.3.4 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.3.6 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.255.254.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | John | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.1.5.3 | 2 | John | - | - | - | - | - | - | - | - |
| 10.255.254.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 30 | 192.168.201.2:20030 | 20030:20030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| John | 192.168.201.2:20 | connected |
...
router bgp 65199
   ...
   neighbor 10.255.254.0 description leaf3
   neighbor 192.168.3.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.4 remote-as 65002
   neighbor 192.168.3.4 description spine3_Ethernet6
   neighbor 192.168.3.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.6 remote-as 65002
   neighbor 192.168.3.6 description spine4_Ethernet6
   ...
   vrf John
      ...
      router-id 192.168.201.2
      neighbor 10.1.5.3 remote-as 2
      neighbor 10.1.5.3 local-as 65198 no-prepend replace-as
      neighbor 10.1.5.3 prefix-list NO_HOST_ROUTES_John out
      neighbor 10.255.254.0 peer group MLAG-IPv4-UNDERLAY-PEER
