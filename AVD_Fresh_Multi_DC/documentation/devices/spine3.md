...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet5 | P2P_LINK_TO_LEAF3_Ethernet5 | routed | - | 192.168.3.0/31 | default | 1550 | False | - | - |
| Ethernet6 | P2P_LINK_TO_LEAF4_Ethernet5 | routed | - | 192.168.3.4/31 | default | 1550 | False | - | - |
| Ethernet8 | P2P_LINK_TO_BORDERLEAF2_Ethernet5 | routed | - | 192.168.3.8/31 | default | 1550 | False | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 192.168.3.1 | 65199 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.3.5 | 65199 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.3.9 | 65203 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 192.168.201.1 | 65199 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
| 192.168.201.2 | 65199 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
...
router bgp 65002
   ...
   neighbor 192.168.3.1 remote-as 65199
   neighbor 192.168.3.1 description leaf3_Ethernet5
   neighbor 192.168.3.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.5 remote-as 65199
   neighbor 192.168.3.5 description leaf4_Ethernet5
   neighbor 192.168.3.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.9 remote-as 65203
   neighbor 192.168.3.9 description borderleaf2_Ethernet5
