...
| --------- | --------------- | ------------ | --------- |
| mlag34 | Vlan4094 | 10.255.255.1 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet5 | routed | - | 192.168.3.1/31 | default | 1550 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet5 | routed | - | 192.168.3.3/31 | default | 1550 | False | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.3.0 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.3.2 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | John | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.1.5.1 | 1 | VRF_A | - | - | - | - | - | - | - | - |
...
| 30 | 192.168.201.1:20030 | 20030:20030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| John | 192.168.201.1:20 | connected |
...
router bgp 65199
   ...
   neighbor 10.255.254.1 description leaf4
   neighbor 192.168.3.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.0 remote-as 65002
   neighbor 192.168.3.0 description spine3_Ethernet5
   neighbor 192.168.3.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.3.2 remote-as 65002
   neighbor 192.168.3.2 description spine4_Ethernet5
   ...
   vrf VRF_A
      ...
      neighbor 10.1.5.1 prefix-list NO_HOST_ROUTES_VRF_A out
      neighbor 10.255.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
      redistribute connected route-map RM-CONN-2-BGP-VRFS
      !
      address-family ipv4
